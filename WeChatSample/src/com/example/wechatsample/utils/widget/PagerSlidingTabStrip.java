...
import com.example.wechatsample.R.styleable;
/**
 * titlebar下面的导航选项（店铺、商品。。。）
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorHeight = 8; //绿条高度
	private int underlineHeight = 2; //绿条底下灰线高度
	private int dividerPadding = 12;
	private int tabPadding = 15; //如果tab平分屏幕宽，则设为0
...
//				tab.setTextColor(R.drawable.tabtextcolor_selector);
	...
	public void setShouldExpand(boolean shouldExpand) {
		...
		// 如果设置tab平分屏幕宽度，则不对tab设padding,否则会遮住文字
		if(!shouldExpand){
			tabPadding = 0; 
		}
		notifyDataSetChanged();
