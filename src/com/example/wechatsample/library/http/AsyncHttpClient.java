...
package com.example.wechatsample.library.http;
...
/**
 * The AsyncHttpClient can be used to make asynchronous GET, POST, PUT, PATCH
...
public class AsyncHttpClient
{
	 ...
	 *            the URL to send the request to.
	 * @param params
	 *            additional PATCH parameters or files to send with the request.
	 * @param responseHandler
	 *            the response handler instance that should handle the response.
	 */
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void patch(Context context, String url, Header[] headers, RequestParams params, String contentType, AsyncHttpResponseHandler responseHandler)
	{
	...
	// Private stuff
	protected void sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, AsyncHttpResponseHandler responseHandler,
			Context context)
	{
		if (contentType != null)
		{
